...
// Adds 'list-group-item' to categoires li
...
// Register widgets
function bootstrapwp_register_widgets(){
	register_widget('WP_Widget_Recent_Post_Custom');
	register_widget('WP_Widget_Recent_Comments_Custom');
	register_widget('WP_Widget_Categories_Custom');
}
add_action('widgets_init', 'bootstrapwp_register_widgets');

// Add Comments
function add_theme_comments($comment, $args, $depth) {
	$GLOBALS['comment'] = $comment;
	extract($args, EXTR_SKIP);
//tags and classes to style that
	if ( 'div' == $args['style'] ) {
		$tag = 'div';
		$add_below = 'comment';
	} else {
